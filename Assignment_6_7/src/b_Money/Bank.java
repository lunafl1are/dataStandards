...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			// Was method of getting account what is wrong, because we should create a new one
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		// Was simple accountlist.containsKey, what is wrong, because we can deposit only when account exist
		if (!accountlist.containsKey(accountid)) {
	...
	public Money getBalance(String accountid) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			// Changed return type of the method, because, as I understood we should return more complex
			// info about money available by the user
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		// third parameter wa fromaccount, should be toaccount
		// as we transfer money from one account into another
	...
	public void addTimedPayment(String accountid, String payid, Integer interval, Integer next, Money amount, Bank tobank, String toaccount) throws AccountDoesNotExistException {
		// Added check whether accounts exist or no
	...
	public void removeTimedPayment(String accountid, String id) throws AccountDoesNotExistException {
		// Added check whether account exist
		if (!accountlist.containsKey(accountid)) {
			throw new AccountDoesNotExistException();
		}
		Account account = accountlist.get(accountid);
