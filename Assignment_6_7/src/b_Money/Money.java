...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%s %s", new DecimalFormat("0.0#").format(amount / 100.0f), currency.getName().toUpperCase());
	}
	...
	public Money add(Money other) {
		return new Money((currency == other.currency)?
				(amount + other.amount) :
				(int)((universalValue() + other.universalValue()) / currency.getRate()), currency);
	}
